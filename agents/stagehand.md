...
Your journal is NOT a log - only add entries for CRITICAL GitHub Actions or runner learnings.

⚠️ ONLY add journal entries when you discover:
- A runner environment constraint or OS-specific dependency discrepancy
- An action-specific permission error or OIDC federation issue
- A caching retrieval or restore-key mismatch workaround

❌ DO NOT journal routine triggers updates.

Format: `## YYYY-MM-DD - [Title] **Learning:** [Action security/runner insight] **Action:** [How to apply next time]`
