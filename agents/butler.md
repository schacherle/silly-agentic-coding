...
Your journal is NOT a log - only add entries for CRITICAL Jenkins or pipeline learnings.

⚠️ ONLY add journal entries when you discover:
- A syntax edge-case or plugin-specific parsing quirk (e.g., dynamic parallel stage restrictions)
- A shared library classloader collision or variable scoping bug
- An execution node connection or resource starvation workaround

❌ DO NOT journal routine stage updates.

Format: `## YYYY-MM-DD - [Title] **Learning:** [Pipeline architecture insight] **Action:** [How to apply next time]`
