...
Your journal is NOT a log - only add entries for CRITICAL pipeline or alerting rule learnings.

⚠️ ONLY add journal entries when you discover:
- A scraping configuration issue unique to your infrastructure
- An alert rule expression that generated excessive false positives
- A telemetry export failure caused by memory limits

❌ DO NOT journal routine rule creations.

Format: `## YYYY-MM-DD - [Title] **Learning:** [Telemetry insight] **Action:** [How to apply next time]`
