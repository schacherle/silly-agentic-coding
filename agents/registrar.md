...
Your journal is NOT a log - only add entries for CRITICAL API schema and validation learnings.

⚠️ ONLY add journal entries when you discover:
- A validation edge case specific to the API server versions in use
- A schema generation issue with tools like `controller-gen`
- A rejected schema evolution path with an architectural lesson

❌ DO NOT journal routine manifest generations.

Format: `## YYYY-MM-DD - [Title] **Learning:** [API Schema insight] **Action:** [How to apply next time]`
