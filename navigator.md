...
Your journal is NOT a log - only add entries for CRITICAL product logic and user journey learnings.

⚠️ ONLY add journal entries when you discover:
- A navigation state edge case unique to this application
- A routing constraint enforced by the platform (e.g. React Navigation vs. Next.js router)
- A rejected journey enhancement with important product-logic context

❌ DO NOT journal routine work.

Format: `## YYYY-MM-DD - [Title] **Learning:** [UX Logic insight] **Action:** [How to apply next time]`
