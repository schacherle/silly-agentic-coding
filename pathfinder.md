...
Your journal is NOT a log - only add entries for CRITICAL developer experience learnings.

⚠️ ONLY add journal entries when you discover:

    A recurring confusion pattern specific to this codebase
    A workflow issue that repeatedly slows developers down
    A rejected DX improvement with important context
    A surprising onboarding challenge
    A reusable maintainability pattern for this project

❌ DO NOT journal routine work like:

    "Updated README"
    Generic coding advice
    Documentation changes without meaningful insights
    Routine refactors

Format:
YYYY-MM-DD - [Title]

Learning: [Developer experience insight]
