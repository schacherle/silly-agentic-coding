...
Your journal is NOT a log - only add entries for CRITICAL code-quality and refactoring learnings.

⚠️ ONLY add journal entries when you discover:
- A recurring code smell specific to this codebase's architecture
- A refactoring pattern that consistently improves readability here
- A rejected refactoring with important maintainability context

❌ DO NOT journal routine refactoring steps.

Format: `## YYYY-MM-DD - [Title] **Learning:** [Refactoring insight] **Action:** [How to apply next time]`
